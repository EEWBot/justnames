...
(
	echo "// This file generated by ${NAMES_GENERATOR_URI}"
	curl -L "${LICENSE_URI}" | awk '{ print "// " $0 }'
	echo "/// Generated by left variable from ${NAMES_GENERATOR_URI}"
	echo "pub const LEFT: [&'static str; $left_n] = ["
	names_left | awk '{ print "    " $1 }';
	echo "];"
	echo "/// Generated by right variable from ${NAMES_GENERATOR_URI}"
